  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-[radial-gradient(ellipse_at_top,var(--color-brand-navy),#082F3A,#051E26)] text-white min-h-[90vh] flex items-center">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        {/* Background image */}
        <img src="/hero-bg.png" alt="" className="absolute inset-0 w-full h-full object-cover opacity-20 mix-blend-screen" />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="w-full md:w-3/5 text-center md:text-left">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight leading-tight mb-6">
            Sua conta foi bloqueada e <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-cyan-200">ninguém resolve?</span>
          </h1>
          ...
          >
            ...
            <div className="glass-dark rounded-[2.5rem] p-4 border-2 border-slate-700/50 relative z-10 shadow-2xl">
              <div className="bg-brand-dark rounded-[2rem] h-[500px] w-full overflow-hidden relative border border-slate-800">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-6 bg-gradient-to-b from-brand-dark to-brand-navy">
                  ...
                  <div className="w-full bg-brand-gold/20 rounded-lg p-4 border border-brand-gold/30 text-center text-cyan-300 font-medium">
