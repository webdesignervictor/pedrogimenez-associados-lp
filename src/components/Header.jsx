      ...
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a 
            ...
            className="bg-brand-cta text-white font-bold py-2.5 px-6 rounded-lg transition-all duration-300 btn-premium-shimmer shadow-premium"
          >
        ...
        <div className="md:hidden absolute top-full left-0 w-full bg-brand-navy border-t border-white/10 shadow-2xl">
          <div className="flex flex-col p-4 gap-4">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-brand-cta text-white font-bold py-3 px-6 rounded-lg text-center mt-2 btn-premium-shimmer"
